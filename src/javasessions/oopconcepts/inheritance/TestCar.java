...
public class TestCar {
	...
	public static void main(String[] args) {
		...
		b.power(); // Inherited. Possible. We CAN INHERIT FINAL methods in JAVA.
		           // O/P : Car -- Power
		BMW.billing(); // Inherited static method. Possible from car class
		...
		Audi.billing(); // Inherited static method of Parent class. Possible
		au.power(); // Inherited final method of parent class. Possible
		Audi.ABS(); // Inherited static final method of parent class. Possible.
...
//		                 // and Hence, override properties from child class
		...
		BMW.billing(); // static method from child 
		               // O/P: BMW -- Billing
