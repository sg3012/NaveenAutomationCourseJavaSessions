...
public class ArrayListMethods {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> ar = new ArrayList<String>();// vc=10, pc=0 (By Default)
		
		ArrayList<String> ar1 = new ArrayList<String>(20); // vc=20, pc=0 (Custom)
...
//		System.out.println(listOfNumbers.size()); // UnsupportedOperation Exception again
		...
		ArrayList<String> monthsList1 = new ArrayList<String>();// vc=10, pc=0
		monthsList1.add("JAN");
		monthsList1.add("FEB");
		monthsList1.add("MAR");
		monthsList1.add("APR");
		...
		ArrayList<Integer> nl = new ArrayList<Integer>(); // vc=10, pc=0
		nl.add(1); //0
		nl.add(2); //1
		nl.add(3); //2
		nl.add(4); //3
